<template>
    <NavigationBar />
    <main
        class="lg:flex lg:justify-between mx-auto max-w-7xl lg:min-h-full lg:flex-row-reverse lg:overflow-hidden lg:px-8 lg:py-4"
    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <div
                                        class="flex border-l border-gray-300 pl-4"
                                    >
                                        <button
                                            type="button"
                                            class="text-sm font-medium text-indigo-600 hover:text-indigo-500"
                    ...
                    >
                        ...
                        <div class="flex justify-between">
                            <dt class="flex">
                                Discount
                                <span
                                    class="ml-2 rounded-full bg-gray-200 py-0.5 px-2 text-xs tracking-wide text-gray-600"
                                    >coupom name</span
                                >
                            </dt>
                            <dd class="text-gray-900">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="text-gray-900">
                                {{
                                    calculateShippingCost().toLocaleString(
                                        "en-US",
                                        {
                                            style: "currency",
                                            currency: "USD",
        ...
        >
            ...
            <div
                class="sticky bottom-0 flex-none border-t border-gray-200 bg-gray-50 p-6"
            >
        ...
        <section
            ...
            class="flex overflow-y-auto px-4 pt-12 pb-16 sm:px-6 sm:pt-16 lg:px-8 lg:pt-0 lg:pb-24"
        >
            <div class="mx-auto max-w-lg pt-10">
                ...
                <div class="relative mt-8">
                    ...
                    <div class="relative flex justify-center">
                        <span
                            class="bg-white px-4 text-sm font-medium text-gray-500"
                            >or</span
                        >
                    </div>
                </div>
                ...
                <form class="mt-6">
                    ...
                    <p
                        class="mt-6 flex justify-center text-sm font-medium text-gray-500"
                    >
                        <LockClosedIcon
...
import type { CartInterface, CouponsInterface } from "@/interfaces";
...
export default {
    ...
    methods: {
        async fetchData() {
            const [productsData, discount] = await Promise.all([
                axios.get("/cart"),
                axios.get("/discount"),
            ]);
            this.products = productsData.data;
            this.coupons = discount.data;
        },
        async checkout() {
        ...
        applyCoupon() {
            const coupon = this.coupons.find(
                (coupon) => coupon.code === this.couponInput
            );
            if (coupon) {
